...
Return _the **exclusive time** of each function in an array, where the value at the _`i^th`_ index represents the exclusive time for the function with ID _`i`.
